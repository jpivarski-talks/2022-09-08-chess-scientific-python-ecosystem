...
\vspace{0.75 cm}
\uncover<2->{Most of the tool developers self-select from among advanced data analysts, and the tools tend to be expert-oriented.}

\vspace{0.75 cm}
\uncover<3->{Python itself is beginner-friendly, but analysis tools often aren't.}
